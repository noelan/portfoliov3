                  ...
                  <div className="carouselSlide myBlack">
                    <div className="contactMe">
                      <p>
                        ...
                        noel.an.lyon@gmail.com
                      </p>
                      <p>
                        <i className="fas fa-phone"></i>06 83 07 54 48
                      </p>
                    ...
                    <div className={hide1 ? "hide" : ""}>
                      ...
                      <Fade right>
                        <div className="textAboutMe test">
                          <p>
                            Bonjour je me présente Noël AN. Après avoir
                            travaillé principalement dans la restauration et la
                            logistique, j'ai décidé de me reconvertir dans un
                            domaine qui m'a toujours passionné, le devéloppement
                            Web.
                          </p>
                          <p>
                            J'ai effectué une formation de développeur web à la
                            Wild Code School qui m'a permis de découvrir ce
                            métier et me spécialiser en PHP Symfony.
                          </p>
                          <p>
